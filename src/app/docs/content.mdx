...
import { aurora } from "@dateforge/react-calendar/themes/aurora";

<Calendar theme={snow}>
  <CalendarToolbar theme={nebula} dark>
    <CalendarToolbarPrev />
    <CalendarToolbarMonthTrigger />
    <CalendarToolbarNext />
    <CalendarToolbarYearTrigger compact />
  ...
  <CalendarDays />
  <CalendarInfo theme={aurora} showSummary showRelative />
</Calendar>
```
...
| `--c-oom` | Out-of-month day text (optional — falls back to `--c-m` when omitted) |
